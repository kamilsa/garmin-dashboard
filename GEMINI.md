...
- **Markdown Support**: The chat assistant renders responses using `react-markdown` and `remark-gfm`, supporting tables, lists, code blocks, and bold metrics for a rich data presentation.
